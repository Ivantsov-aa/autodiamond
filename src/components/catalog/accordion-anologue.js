...
class AccordionAnalogue extends React.Component {
    ...
    //     // this.props.setProductForCart(this.state.currentProducts);
    // }
    ...
    render() {
        ...
        return (
            currentProducts.map((item, i) => (
                <div key={i}>
                    <Link to={location + '/' + item.article} className='analogue__wrapper' onClick={() => this.handleProductForCart(currentProducts)}>
